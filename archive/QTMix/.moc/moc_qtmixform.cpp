...
**
** Created: Fri Jun 10 10:41:33 2005
...
QMetaObject* QTMixForm::staticMetaObject()
{
    ...
    static const QUMethod slot_8 = {"setEmbImpedance", 0, 0 };
    ...
    static const QUMethod slot_11 = {"setPlotXaxis", 0, 0 };
    static const QUMethod slot_12 = {"setJunction", 0, 0 };
	...
	{ "setEmbImpedance()", &slot_8, QMetaData::Public },
	{ "setHarmonics(int)", &slot_9, QMetaData::Public },
	{ "setIVdata()", &slot_10, QMetaData::Public },
	{ "setPlotXaxis()", &slot_11, QMetaData::Public },
	{ "setJunction()", &slot_12, QMetaData::Public },
...
bool QTMixForm::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 8: setEmbImpedance(); break;
    case 9: setHarmonics((int)static_QUType_int.get(_o+1)); break;
    case 10: setIVdata(); break;
    case 11: setPlotXaxis(); break;
    case 12: setJunction(); break;
