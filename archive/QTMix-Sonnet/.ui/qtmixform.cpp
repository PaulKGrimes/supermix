...
**
** Created: Tue May 17 11:07:09 2005
    ...
    : QDialog( parent, name, modal, fl )
{
    ...
    IFfreqDoubleSpinBox->setValue( 0 );
    ...
    layout17->addWidget( textLabel1_7 );
    spacer43 = new QSpacerItem( 31, 20, QSizePolicy::Expanding, QSizePolicy::Minimum );
    layout17->addItem( spacer43 );

    sonnetFileChooser = new FileChooser( TabPage, "sonnetFileChooser" );
    layout17->addWidget( sonnetFileChooser );
    TabPageLayout->addLayout( layout17 );
    spacer44 = new QSpacerItem( 20, 261, QSizePolicy::Minimum, QSizePolicy::Expanding );
    TabPageLayout->addItem( spacer44 );
    ...
    connect( sonnetFileChooser, SIGNAL( fileNameChanged(const QString&) ), this, SLOT( setTuner() ) );
...
{
    setCaption( tr( "QT Mix - Sonnet Tuned Mixer" ) );
    ...
    textLabel1_7->setText( tr( "Touchstone File:" ) );
    sonnetFileChooser->setFileName( QString::null );
