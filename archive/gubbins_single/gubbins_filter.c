...
int main(int argc, char **argv)
	{
		...
		parameter L1 = 79.*Micron;
		parameter L2 = 169.*Micron;
		parameter W1 = 2.5*Micron;
		parameter W2 = 2.6*Micron;
		parameter C1 = 29.0*epsVacuum*1.0*Micron*3.0*Micron/(400*Nano*Meter);
