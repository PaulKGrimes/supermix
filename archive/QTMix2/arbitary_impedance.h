...
/**
 * @file arbitary_impedance.h
 *
 * Defines arbitary_impedance child of spimp
 *
 * @author Paul Grimes
...
class arbitary_impedance : public spimp
{
public:
  complex_parameter Z;
  ...
  explicit arbitary_impedance(Complex z = 0.0)
    : spimp(), Z(z), Temp(&T) {  }

  explicit arbitary_impedance(const abstract_real_parameter * z)
    : spimp(), Z(z), Temp(&T) {  }

  arbitary_impedance & set(Complex z)
  { Z = z; return *this; }

  arbitary_impedance & set(abstract_complex_parameter * z)
  { Z = z; return *this; }

  arbitary_impedance & set_T(double t)
  { Temp = t; return *this; }

  arbitary_impedance & set_T(abstract_real_parameter * t)
  { Temp = t; return *this; }
