/****************************************************************************
** Form implementation generated from reading ui file 'qtmixform2.ui'
**
** Created: Tue Jun 28 12:10:13 2005
**      by: The User Interface Compiler ($Id: qt/main.cpp   3.3.4   edited Nov 24 2003 $)
**
** WARNING! All changes made in this file will be lost!
****************************************************************************/

#include "qtmixform2.h"
    ...
    : QDialog( parent, name, modal, fl )
{
    ...
    loVoltDoubleSpinBox->setMaxValue( 100 );
    loVoltDoubleSpinBox->setLineStep( 0.1 );
    loVoltDoubleSpinBox->setValue( 1 );
    loVoltDoubleSpinBox->setDisplayPrecision( 3 );
    ...
    freqDoubleSpinBox->setMaxValue( 5000 );
    freqDoubleSpinBox->setMinValue( 5 );
    freqDoubleSpinBox->setLineStep( 5 );
    freqDoubleSpinBox->setValue( 220 );
    freqDoubleSpinBox->setDisplayPrecision( 1 );
    ...
    IFfreqDoubleSpinBox->setMaxValue( 500 );
    IFfreqDoubleSpinBox->setLineStep( 1 );
...
void QTMixForm::languageChange()
{
    ...
    loVoltDoubleSpinBox->setSuffix( tr( " mV" ) );
