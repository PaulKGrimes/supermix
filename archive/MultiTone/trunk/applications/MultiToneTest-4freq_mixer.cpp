...
int main()
{
    ...
    cout << "# Signal Volts | Unpumped DC | KK | DC Current | Pump Current | IF Current | Signal Current | Image Current | DC dynamic impedance | Iterations\n";
