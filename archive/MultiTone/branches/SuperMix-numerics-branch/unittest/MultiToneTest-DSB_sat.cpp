    ...
    for (int v=0; v<=40; v++)
    {
        ...
        for (int phi=0; phi <360; phi+=12)
        {
            ...
            for (int phi2=0; phi2 <360; phi2+=12)
            {
                ...
                Complex phasor = Complex(cos((double)phi/180.*Pi), sin((double)phi/180.*Pi));
                Complex phasor2 = Complex(cos((double)phi2/180.*Pi), sin((double)phi2/180.*Pi));
