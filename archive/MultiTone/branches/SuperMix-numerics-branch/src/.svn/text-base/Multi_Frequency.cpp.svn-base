...
Complex Multi_Frequency::get_Ck(double freq)
{
...
Complex Multi_Frequency::get_Ck(int f, int h)
{
    double freq = get_freq(f, h);
    return get_Ck(freq);
}


double Multi_Frequency::get_min_Ck()
{
    return min_Ck;
}


void Multi_Frequency::set_min_Ck(double min)
{
    min_Ck = min;
...
void Multi_Frequency::add_frequency(double freq)
{
    One_Frequency newFreq;
    newFreq.set_F(freq);
...
void Multi_Frequency::add_harmonic(int f, Complex Vs, Complex Zt)
{
...
double Multi_Frequency::get_freq(int f)
{
    return Frequencies.at(f).get_F();
}


double Multi_Frequency::get_freq(int f, int h)
{
    return Frequencies.at(f).get_F()*(h+1);
}


int Multi_Frequency::get_f(double freq)
{
...
int Multi_Frequency::get_h(double freq)
{
    int h=0;
...
void Multi_Frequency::set_freq(int f, double newFreq)
{
...
void Multi_Frequency::set_F0(double newF0)
{
...
void Multi_Frequency::set_Vn(int f, int h, Complex V)
{
...
void Multi_Frequency::set_Vs(int f, int h, Complex V)
{
    Frequencies.at(f).set_Vs(h, V);
}


void Multi_Frequency::set_Zt(int f, int h, Complex Z)
{
